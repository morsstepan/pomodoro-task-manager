...
Сейчас позволяет авторизоваться, создавать проекты с указанием даты их планируемого завершения и удалять их. Еще нужно:
 ...
 - [x] ~~Редактировать название и дату завершения проектов~~
 - [x] ~~Добавление туду в проект и работа с ними~~
 - [x] ~~Развернуть это все где-нибудь~~
 - [x] ~~Добавить Pomodoro-таймер~~
